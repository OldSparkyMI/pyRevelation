...
class Clipboard(GObject.GObject):
    ...
    def __init__(self):
        ...
        self.clip_clipboard = Gtk.Clipboard.get(Gdk.Atom.intern("CLIPBOARD", False))
        self.clip_primary = Gtk.Clipboard.get(Gdk.Atom.intern("PRIMARY", False))
...
GObject.signal_new("content-toggled", EntryClipboard, GObject.SignalFlags.ACTION, GObject.TYPE_BOOLEAN,
...
class EntryStore(Gtk.TreeStore):
    ...
    def get_popular_values(self, fieldtype, threshold=3):
        ...
        while iter is not None:
            ...
            if e.has_field(fieldtype) is False:
            ...
            if value != "":
                if valuecount in value is False:
                    valuecount[value] = 0
